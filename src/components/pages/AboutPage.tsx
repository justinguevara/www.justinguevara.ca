            ...
            <div className="center-block-element content-width">
                <div className="primary-content-container">
                    <section className="first-section">
                        ...
                        <p>For nearly a decade, I've worked as a software developer for various companies throughout Toronto, both through freelance, and as a in-house developer.</p>
